    ...
    internal class Contabilidad
    {
        public static void contabilidad()
        {
            ...
            while (chosenActionContabilidad != "x")
            {
                ...
                Console.WriteLine();
                Console.WriteLine("reporte602: genera un reporte tipo 602");
                Console.WriteLine();
                Console.WriteLine("reporte606: genera un reporte tipo 606");
                Console.WriteLine();
                Console.WriteLine("reporte608: genera un reporte tipo 608");
                Console.WriteLine();
